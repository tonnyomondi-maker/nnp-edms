...
import { Home, BookOpen, FileText, Users, Shield, ClipboardList, BarChart3, Settings, FileArchive, Upload, LayoutDashboard, Database, ScrollText, ShieldCheck, UserCheck, ListChecks, Activity, CalendarClock, FileStack } from 'lucide-react';
